...
app.post('/login/radius', passport.authenticate('local-radius', { failureRedirect: '/login', session: false }), // we indicate that this endpoint must pass through our 'username-password' passport strategy, which we defined before
    (req, res) => {
    	console.log("hello")
